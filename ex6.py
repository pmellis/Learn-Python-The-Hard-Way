...
# Print "I said: 'There are 10 types of people.'" Use the %r for debugging, since it displays the "raw" data of the variable, but the others are used for displaying to users.
